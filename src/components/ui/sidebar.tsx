...
>(({ className, children, ...props }, ref) => {
    const { isMobile, openMobile, setOpenMobile, state, collapsible, variant, side } = useSidebar()
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[collapsible=icon]:peer-data-[side=left]:ml-[--sidebar-width-icon]",
        "md:peer-data-[state=expanded]:peer-data-[side=right]:mr-[--sidebar-width]",
        "md:peer-data-[collapsible=icon]:peer-data-[side=right]:mr-[--sidebar-width-icon]",
